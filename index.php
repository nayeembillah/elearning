...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;500;700&family=Orbitron:wght@700&family=Freestyle+Script&display=swap" rel="stylesheet">
    ...
    <style>
        * {
        ...
        .header-text {
            position: absolute;
            top: 140px;  /* moved down to be below logo */
            left: 30px;
        ...
        .punchline .line2 {
            ...
            font-size: 42px; /* 10px bigger than line1 */
            font-weight: 900;
            margin-top: 5px;
        }
