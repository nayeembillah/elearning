    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            ...
            $query = "SELECT
                        ...
                        ce.mark_perct        -- Percentage of marks
                      FROM course c
                ...
                <tbody>
                    ...
                    if (mysqli_num_rows($query_run) > 0) {
                        ...
                        while ($exam_row = mysqli_fetch_assoc($query_run)) {
                            ...
                            // Check for ongoing/completed attempts in exam_attempts (still good for robust checks)
                            ...
                            mysqli_stmt_close($stmt_attempt);
                    ?>
                            <tr>
                                <td><?= $counter; ?></td>
                                <td><?= $exam_id; ?></td>
                                ...
                                <td>
                                    ...
                                    ?>
                                        ...
                                        <?php endif; ?>
                                        <?php
                                        // *** REMOVED THE EXPLICIT STATUS DISPLAY HERE ***
                                        // if ($enrollment_status == 'Pass' || $enrollment_status == 'Fail') :
                                        //     echo '(Status: <strong>' . htmlspecialchars($enrollment_status) . '</strong>)';
                                        // endif;
                                        ?>
